function substractObj(mws,componentName1,objName1,componentName2,objName2)
%substractObj 布尔运算减
...
invoke(mws,'AddToHistory',sprintf('boolen subtract shapes:"%s:%s", "%s:%s"',componentName1,objName1,componentName2,objName2),scomment);
end
