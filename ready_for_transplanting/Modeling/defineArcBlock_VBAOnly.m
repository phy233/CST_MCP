function scommend_out = defineArcBlock_VBAOnly(mws,command,componentName,objName,material,thick,width,thita,centerPoint,startPoint,orientation)
%DEFINEARCBLOCK 新建一个圆环，但是只有VBA
%   此处显示详细说明
...
scommend_tmp1 = defineArc_VBAOnly(command,orientation,centerPoint,startPoint,thita,tmpComName,tmpObjName);

scomment = [scommend_tmp1 10 'With TraceFromCurve'];
